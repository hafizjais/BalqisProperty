...
export default function InquiryPanel({ listing }: { listing: Listing }) {
  ...
  return (
    <>
      ...
      <div className="hidden rounded-2xl border border-white/10 bg-graphite p-6 shadow-card lg:block">
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 flex items-center justify-between gap-3 border-t border-white/10 bg-graphite px-4 py-3 pr-24 shadow-[0_-4px_24px_rgba(0,0,0,0.55)] lg:hidden">
